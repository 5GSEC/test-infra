...
REPO=${NEPHIO_REPO:-$(get_metadata nephio-test-infra-repo "https://github.com/5gsec/test-infra.git")}
...
NEPHIO_CATALOG_REPO_URI=${NEPHIO_CATALOG_REPO_URI:-$(get_metadata nephio-catalog-repo-uri "https://github.com/5gsec/catalog.git")}
